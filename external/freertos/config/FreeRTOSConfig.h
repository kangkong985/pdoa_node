...
#define configTOTAL_HEAP_SIZE                                                     ( 0x6000 )
...
//#if defined(DEBUG_NRF) || defined(DEBUG_NRF_USER)   // TBD always use config_assert
...
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY    _PRIO_SD_LOWEST
